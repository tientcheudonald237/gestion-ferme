        ...
        <div class="col-md-6">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-primary text-white-all">
                    ...
                    <li class="breadcrumb-item active"><a href="#"></i>Mis bas</a>
                    </li>
                </ol>
            </nav>
        </div>
                ...
                <div class="card-body">
                    <form action="{{ route('follow.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Weight" name="weight" required id="weight">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" placeholder="Selectionner la loge" name="id_lodge" required id="id_lodge">
                        ...
                        <input type="hidden" name="is_to_buy" value="0">
