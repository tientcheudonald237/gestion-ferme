                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="/"> <img alt="image" src="assets/img/logo.png" class="header-logo" />
                            <span class="logo-name">KITABU</span>
                        </a>
                    </div>
                    <ul class="sidebar-menu">
                        <li class="menu-header">Main</li>
                        <li class="dropdown active">
                            <a href="{{ route('partner.dashboard.index') }}" class="nav-link"><i
                                    data-feather="monitor"></i><span>Dashboard</span></a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="briefcase"></i><span>{{ __('messages.rental_house_car') }}</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link"
                                        href="{{ route('partner.rent-car.index') }}">{{ __('messages.view_all_companies') }}</a>
                                </li>
                                <li><a class="nav-link"
                                        href="{{ route('partner.rent-car.create') }}">{{ __('messages.add_companies') }}</a>
                                </li>
                                <li><a class="nav-link"
                                        href="{{ route('partner.car_brand') }}">{{ __('messages._add_new_brand') }}</a>
                                </li>
                                <li><a class="nav-link"
                                        href="{{ route('partner.add_new_vehicle') }}">{{ __('messages.add_car_to_companies') }}</a>
                                </li>
                        ...
                        <li class="dropdown">
                            <a href="#" class="menu-toggle nav-link has-dropdown"><i
                                    data-feather="briefcase"></i><span>{{ __('messages._accomodations') }}</span></a>
                            <ul class="dropdown-menu">
                                <li><a class="nav-link"
                                        href="{{ route('partner.accomodation.index') }}">{{ __('messages._view_all_accomodations') }}</a>
                                </li>
                                <li><a class="nav-link"
                                        href="{{ route('partner.accomodation.create') }}">{{ __('messages._add_accomodation') }}</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown">
